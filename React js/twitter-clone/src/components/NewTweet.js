...
export const NewTweet = () => {
    const profImageurl = 'https://pbs.twimg.com/profile_images/1177648329716453376/61dWt1Wx_400x400.jpg';
            ...
            <div className="right">
                <div className="flex-align-center">
                    ...
                    <span className="w-100">
                        <input className="w-100" placeholder="Tweet what's going on?" type="text" onChange={(event) => setContent(event.target.value)} /></span>
                </div>
